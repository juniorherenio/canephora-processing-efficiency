...
#
# Correct numbering (manuscript V2):
...
# ══════════════════════════════════════════════════════════════════════════════
# FIGURE 1 — Climograph: temperature (A), precipitation (B), humidity (C)
# ══════════════════════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════════════════════
# FIGURE 2 — Variance decomposition (A) + H² Bayes vs REML (B)
# ══════════════════════════════════════════════════════════════════════════════
cat("Generating Fig. 2 — Varcomp + H²...\n")

# (A) proportion of components — Bayesian medians
df_vc <- res_bayes |>
...
# ══════════════════════════════════════════════════════════════════════════════
# FIGURE 4 — Probability of consistent superiority — FWM/bag (lollipop)
# ══════════════════════════════════════════════════════════════════════════════
cat("Generating Fig. 4 — Lollipop consistent prob...\n")
...
# ══════════════════════════════════════════════════════════════════════════════
# FIGURE 5 — Performance × Stability (Wricke's ecovalence)
# ══════════════════════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════════════════════
# FIGURE 6 — Multi-trait: BLUPs scatter (A) + correlations by component (B)
# ══════════════════════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════════════════════
# FIGURE 7 — UPGMA Mahalanobis Dendrogram (A) + PCA biplot (B)
# ══════════════════════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════════════════════
# FIGURE S1 — Variance decomposition REML vs Bayes (full comparison)
# ══════════════════════════════════════════════════════════════════════════════
cat("Generating Fig. S1 — REML vs Bayes varcomp...\n")
...
# ══════════════════════════════════════════════════════════════════════════════
# FIGURE S2 — Heatmap probability by year (all genotypes, 20%)
# ══════════════════════════════════════════════════════════════════════════════
cat("Generating Fig. S2 — Heatmap prob. by year...\n")
...
# ══════════════════════════════════════════════════════════════════════════════
# FIGURE S3 — Year:block test — ΔAIC
# ══════════════════════════════════════════════════════════════════════════════
cat("Generating Fig. S3 — Year:block test...\n")
...
# ══════════════════════════════════════════════════════════════════════════════
# FIGURE S4 — Mahalanobis distance matrix heatmap
# ══════════════════════════════════════════════════════════════════════════════
cat("Generating Fig. S4 — Mahalanobis distance heatmap...\n")

# reconstruct matrix from saved BLUPs, same logic as Fig. 7
...
cat("\nGenerated files:\n")
cat("  Main: Fig1_climograma | Fig2_varcomp_h2 | Fig3_rGA\n")
cat("        Fig4_prob_consistente | Fig5_desempenho_estabilidade\n")
cat("        Fig6_multitrait | Fig7_divergencia\n")
cat("  Supplementary: FigS1_reml_vs_bayes | FigS2_heatmap_prob\n")
